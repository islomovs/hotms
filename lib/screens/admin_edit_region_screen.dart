...
class AdminEditRegionScreen extends StatefulWidget {
  static const routeName = '/admin-edit-region-screen';
  const AdminEditRegionScreen({super.key});

  @override
  State<AdminEditRegionScreen> createState() => _AdminEditRegionScreenState();
}

class _AdminEditRegionScreenState extends State<AdminEditRegionScreen> {
      ...
      body: Row(
        ...
        children: [
          SidebarTemplate(
            ...
            unselectedRoutes: const [AdminEditRegionScreen.routeName],
          ),
          Expanded(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  HeadingWidget(title: 'Edit Region'),
