...
class AdminDispensersListScreen extends StatelessWidget {
  static const routeName = '/admin-dispensers-list-screen';
  const AdminDispensersListScreen({super.key});
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.of(context).pushNamed(
                                        AdminAddDispensersScreen.routeName);
                                  },
                                  child: Icon(
                                    Icons.add,
                                ...
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.of(context).pushNamed(
                                            AdminEditDispenserScreen.routeName);
                                      },
                                      child: Text(
                                        'Enter',
                                        style: TextStyle(
