...
import './admin_add_patient_screen.dart';
import './admin_edit_patient_screen.dart';

class AdminPatientsListScreen extends StatelessWidget {
  static const routeName = '/admin-patients-list-screen';
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.of(context).pushNamed(
                                        AdminAddPatientScreen.routeName);
                                  },
                                  child: Icon(
                                    Icons.add,
                                ...
                                Container(
                                  ...
                                  child: Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.of(context).pushNamed(
                                            AdminEditPatientScreen.routeName);
                                      },
                                      child: Text(
                                        'Enter',
                                        style: TextStyle(
